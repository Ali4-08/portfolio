...
export default function Projects() {
  // داده‌های پروژه‌ها (بعداً می‌تونی از JSON یا CMS بگیری)
  const projects = [
    {
      id: 1,
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              whileHover={{ y: -12 }} // موقع hover کارت بالا بیاد
            ...
            >
              ...
              <div className="relative overflow-hidden h-56">
                <motion.div
                  ...
                  className="w-full h-full bg-linear-to-br from-cyan-400 to-blue-600"
                >
                  <div className="flex items-center justify-center h-full text-6xl font-black text-white/20">
                    {project.title[0]}
                  </div>
                </motion.div>
